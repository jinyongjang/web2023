        ...
        <div className="slider__img">
          <div className="slider s1 container">
            ...
            <div className="img" aria-label="hidden">
              <img src="../../asset/images/slider/sliderIcon7.png" alt="이미지1" />
              <img src="../../asset/images/slider/sliderIcon5.png" alt="이미지2" />
              <img src="../../asset/images/slider/sliderIcon6.png" alt="이미지3" />
            </div>
